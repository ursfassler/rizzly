...
import cir.expression.reference.RefMiddle;
...
public abstract class Traverser<R, P> {
  public R traverse(CirBase obj, P param) {
  ...
  protected R visit(CirBase obj, P param) {
    if (obj == null)
  ...
  protected abstract R visitIntType(IntType obj, P param);
